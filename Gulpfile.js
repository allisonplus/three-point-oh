...
gulp.task('clean:pot', function() {
	return del(['languages/atarr.pot']);
});
...
gulp.task('wp-pot', ['clean:pot'], function() {
	...
	.pipe(wpPot({
		...
		destFile:'atarr.pot',
		package: 'atarr',
		bugReport: 'http://http://localhost:8888/at-dark/',
		lastTranslator: 'John Doe <mail@http://localhost:8888/at-dark/>',
		team: 'Team <mail@http://localhost:8888/at-dark/>'
	}))
...
gulp.task('watch', function() {
	...
	browserSync({
		...
		proxy: "testing.dev",    // Use http://http://localhost:8888/at-dark/:3000 to use BrowserSync
		watchOptions: {
